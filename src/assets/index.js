...
export { default as WhatsappIcon } from "./icons/WhatsappIcon.svg";

// images
export { default as backEnd } from "./images/back-end.jpg";
export { default as blurImg } from "./images/blur.jpg";
export { default as frontendImg } from "./images/Front-end.jpg";
export { default as imgRutes } from "./images/img_rutes.jpg";
